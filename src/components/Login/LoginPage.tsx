const LoginPage = () => {
  ...
  return <div className="w-2/5 w-full p-8 bg-white md:flex md:items-center md:justify-center sm:w-auto md:h-full xl:w-2/5 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none">
  <div className="w-full max-w-md space-y-8">
    ...
    <div className="flex flex-row items-center justify-center space-x-3">
      ...
      <a href="https://twitter.com/ajeemon?lang=en" target="_blank"
        className="inline-flex items-center justify-center text-lg font-bold text-white transition duration-300 ease-in bg-blue-400 cursor-pointer w-11 h-11 rounded-2xl hover:shadow-lg"><img
          className="w-4 h-4"
      ...
      <a href="https://in.linkedin.com/in/ajeeshmon" target="_blank"
        className="inline-flex items-center justify-center text-lg font-bold text-white transition duration-300 ease-in bg-blue-500 cursor-pointer w-11 h-11 rounded-2xl hover:shadow-lg"><img
    ...
    <form className="mt-8 space-y-6" action="#" method="POST">
      ...
      <div className="relative">
        <div className="absolute mt-4 right-3"><svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-green-500"
      ...
      <p className="flex flex-col items-center justify-center mt-10 text-center text-gray-500 text-md">
        ...
        <a href="#"
          className="text-indigo-400 no-underline transition duration-300 ease-in cursor-pointer hover:text-blue-500 hover:underline">Sign
          up</a>
      </p>
    </form>
  </div>
