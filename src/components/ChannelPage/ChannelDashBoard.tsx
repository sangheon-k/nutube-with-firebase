      ...
      <div className="px-40">
        ...
        <div className="p-4">
            ...
            <div className="flex flex-1">
              <div className="mt-[-6rem]">
                <div className="relative rounded-full md avatar h-[9rem] w-[9rem]">
                  <Image
                    className="relative border-4 border-gray-900 rounded-full md h-[9rem] w-[9rem]"
          ...
          <div className="justify-center w-full mt-3 ml-3 space-y-1">
            {/* <!-- User basic--> */}
            <div>
              <h2 className="text-xl font-bold leading-6 text-white">Text</h2>
            ...
            <div className="flex items-start justify-start w-full pt-3 divide-x divide-gray-800 divide-solid">
